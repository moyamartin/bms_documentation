...
\begin{frame}
  ...
  implementar se puede observar en la figura \ref{fig:ModeloBat} basado en el
  circuito de Randle %TODO: agregar referencia
  ...
  \begin{figure}
	...
	\begin{center}
	  ...
	  \caption{Circuito de Randle de segundo órden.}
	  \label{fig:ModeloBat}
	\end{center}
  \end{figure}
...
\begin{frame}
  ...
  suma de exponenciales, como la observada en la Ecuación \ref{eq:exp2}, a la 
  evolución del voltaje en terminales de la bateria en su semi-periodo de 
  relajación. De esta forma comprobamos que el orden del modelo nos permite 
  replicar las dinámicas de una celda.
...
\begin{frame}[allowframebreaks]
  ...
  \begin{figure}
	...
	\caption{Modelo Simulink del circuito de Randle}
