...
\section{Modelado celda de Ion-Litio}
...
\begin{frame}[allowframebreaks]
	...
	\begin{figure}[h!]
	  \centering
%TODO	  \includegraphics[width=1\textwidth]{images/EMF_relaxation.png}
...
\begin{frame}[allowframebreaks]
  \frametitle{Estimación por resistencia interna}
	...
	\begin{figure}[h!]
	  \centering
%TODO	  \includegraphics[width=1\textwidth]{./images/Ro_vs_SOC.png}
...
\begin{frame}[allowframebreaks]
  ...
  \begin{figure}[h!]
	\centering
%TODO	\includegraphics[width=0.5\textwidth]{./images/EIS_Nyquist.png}
