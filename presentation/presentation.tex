...
\begin{frame}[allowframebreaks]
\frametitle{Celda - Dataset - Ensayo HPPC (Hybrid Pulse Power Characterization}

Celda seleccionada: baterías comerciales denominadas NCR18650B

\begin{figure}[h!]
	\includegraphics[width=0.1\linewidth]{images/18650}
	\caption{NCR18650B}
	\label{fig:18650}
\end{figure}
...
Ensayo HPPC (Hybrid Pulse Power Characterization)


\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{images/perfil_de_ensayo_HPPC}
	\caption{}
