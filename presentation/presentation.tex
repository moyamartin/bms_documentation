...
%\end{figure}
  ...
  *Dataset: Ensayos realizador en la University of Wisconsin-Madison por el Dr. 
  Phillip Kollmeyer (phillip.kollmeyer@gmail.com). 
...
\begin{frame}
  ...
  El modelo equivalente propuesto para representar nuestras celdas cuentan con una 
  fuente de tensión \emph{Em} emulando la tensión de circuito abierto en serie con 
  una resistencia \emph{R0} y dos tanques paralelos \emph{R-C} también conectados 
  en serie como se observa en la figura \ref{fig:ModeloBat}
...
%El código implementa un algoritmo de optimización numerica a partir del uso de la herramienta \emph{Estimador de parámetros} de simulink, parte del Toolbox Indentificador de Sistemas.
