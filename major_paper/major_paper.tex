...
El informe se encuentra dividido en 8 secciones, las mismas atienden a los siguientes enfoques:
...
\begin{itemize}
	...
	\item Sección \ref{desarrollo}: Se describe el desarrollo del modelo mátemático de la celda de Ion-Litio y su implementación en un Filtro de Kalman.
