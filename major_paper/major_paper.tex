...
Durante todo el ensayo \acrshort{HPPR} podemos observar per\'iodos de descanso
...
\begin{figure}[h!]
    \begin{center}
        ...
        \caption{Toma del valor de \acrshort{OCV} y extrpolación}
...
En este capítulo se enumeran y detallan el criterio de elección y desarrollo de todos los circuitos y componentes de los subsistemas del BMS, los mismos son:
...
Este dispositivo es el que centraliza toda la información, es el encargado de recibir procesar, almacenar y retransmitir todos los datos provenientes de los subsistemas del BMS por los puerto de comunicación, en este caso CAN y UART.
Para llevar a cabo estas tareas debe ser capaz de interpretar y poder comunicarse con los sensores, y tener la capacidad de computo y frecuencia necesarias para cumplir con los tiempos de muestreo y la ejecución del Filtro de Kalman.
...
Por otro lado también se encarga de accionar los transistores de ByPass según comandos de la unidad de procesamiento para balancear las celdas en base al estado de carga estimado por el Filtro de Kalman
...
Este dispositivo es el que finalmente nos provee la corriente que circula a través de las celdas hacia la carga o desde el cargador. El dato de la corriente es clave para el correcto funcionamiento del Filtro de Kalman y además  nos permite tomar acciones de seguridad en caso de valores de corriente elevados o variaciones bruscas.
