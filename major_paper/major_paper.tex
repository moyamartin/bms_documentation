...
resistencia $R_{DS(on)}$ que presentan operando en directa, en comparación a un
diodo Schottky. Q8 a su vez provee al circuito la capacidad de variar la
...
sobre voltaje.  La disipasión de energía en R38 es indeéndiente de su valor ya
...
\begin{figure}[h!]
    \begin{center}
	\includegraphics[width=0.7\textwidth]{hardware/bat_charger/bc_set_points.png}
...
\subsubsection{Interfaz de estado de carga}
...
esta funcionalidad y recomenddamos cargar el pack de batería de forma segura y
micro-controlada.
