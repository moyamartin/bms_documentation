...
\begin{itemize}
	...
	\item Cap\'itulo \ref{ensayos}: Se presentan los ensayos realizados a lo 
        largo del proyecto para validar los modelos y el funcionamiento del
        hardware.
	\item Cap\'itulo \ref{conclusiones}: Se presentan los resultados de la
        experiencia del proyecto y, consecuentemente, los conocimientos 
        adquiridos, asi cómo también se presentan futuras mejoras y extensiones
        del mismo.
\end{itemize}
