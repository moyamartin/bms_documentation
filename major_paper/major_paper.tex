...
\begin{document}
    ...
    Por el otro lado, durante el proceso de descarga, con la intercalación de \ce{Li+} dentro de 
...
voltaje, llevan a un pack de baterías más desbalanceado que sin ellos.
    ...
    % La carga del pack de batería no es un proceso trivial y la extensión de la vida util del mismo depende profundamente de poder controlar el mismo con detalle. 

    % El control completo de la operación del pack de batPoder controlar 
    % Extender la vida util del pack de baterías no es un tema trivial como ya hemos expuesto anteriormente. El balanceo de carga es
