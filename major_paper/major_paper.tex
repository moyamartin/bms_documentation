...
Instruments. Implementa un convertirdor de energía DC-DC del tipo buck sin
aislamiento que nos permite optener un perfil de tensión y corriente controlado
como el descripto en la sección \ref{sec:tecnica_carga} a partir de una fuente
de alimentación de tensión continua externa.
...
El circuito de entrada de nuestro cargador de batería consta una red de descarga
