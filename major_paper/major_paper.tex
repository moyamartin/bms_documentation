...
\subsubsubsection{Ensayos unitarios}
...
\begin{minipage}{0.5\textwidth}
    \begin{center}
        ...
        \caption{Descripci\'on gr\'afica del ejemplo de la estimaci\'on de
...
canal de comunicación \imph{SPI}. La inicialización y puesta en marcha del
...
\subsubsubsection{Driver TI - INA226}
