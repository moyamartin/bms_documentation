...
Los drivers de control de los diferentes \acrshort{CI} fueron desarrollados
integramente en lenguaje de programación C y se valen de las librerías de
la capa \acrshort{HAL} para poder interactuar con los periféricos de
comunicación del \acrshort{MCU}.
...
\begin{itemize}
    \item \texttt{bq76\_init()}: Inicializar una instancia del driver bq76 y
        el \acrshort{CI} con los parámetros de configuración seleccionados.
\subsubsubsection{Driver TI - bq2461x}
\end{itemize}
...
la Secci\'on \ref{dev_soc_est}, como resultado se desarroll\'o una \acshort{API}
...
mismo hardware pero con un modelo con menos variables.
