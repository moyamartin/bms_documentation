...
\noindent En \cite{Moss} sugiere la substituci\'on de la impedancia de 
...
Kramers-Kronig \cite{Schmidt2013}, que pueden ser aplicadas en redes equivalentes, 
...
celdas. Los resultados muestran un modelo t\'ermico-elecroqu\'imico acoplado que 
...
carga y descarga. En \cite{shen_cell_bal} se propone un esquema de 
...
En \cite{CAMPESTRINI2016142} estudia el balanceo pasivo tradicional de celdas de 
litio-ion usando 8 m\'odulos conectados en serie, cada uno compuesto por 14 
...
combina una resistencia shunt con MOSFETs. The \acrshort{PBC} fue implementado 
...
celda de niquel-metal o niquel-zinc en paralelo. Las celdas de litio-ion pueden 
alcanzar la ecualizaci\'on con el proceso electroqu\'imico de las celdas de 
niquel. Los resultados verifican que este m\'etodo es posible de implementar, 
...
entre los m\'odulos de las bater\'ias. \cite{lu_et_al_bal} propone un 
controlador aislado bidireccional tipo \acrshort{C2M} con una conmutaci\'on 
suave a cero voltaje. Cuando funciona en modo \emph{boost}, el convertidor puede 
transferir energ\'ia de la bater\'ia al m\'odulo, mientras que cuando funciona 
en modo \emph{buck} la transferencia de energ\'ia se realiza desde el m\'odulo a 
la celda descargada. \'Esta metodolog\'ia demuestra resultados experimentales 
con buen rendimiento tanto en velocidad como eficiencia.
...
que esta implementaci\'on sea m\'as dificultosa que el resto. 
\cite{ji_et_al_bal_mod} propone un esquema de ecualizaci\'on usando m\'ultiples 
transformadores que con los cuales la energ\'ia puede ser transferida entre 
m\'odulos de distintos voltajes, alcanzado una corriente de balanceo a 3A 
mientras que la inconsistencia entre voltajes es de 24mV.

Otros m\'etodos no ilustrados en la Figura \ref{energy_transfer} tambi\'en
fueron estudiados. \cite{li_et_al_bal} propone una topolog\'ia de ecualizaci\'on
...
convertidores tipo flyback, que puede transferir energ\'ia entre la bater\'ia y 
...
carga que circula por el pack de bater\'ias. Los resultados de muestran que 
este m\'etodo es robusto y puede ecualizar el sistema en un tiempo corto.
