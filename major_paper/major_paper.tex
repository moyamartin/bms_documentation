...
\begin{comment} El informe se encuentra dividido en 6 secciones, en la Sección \ref{descripcion}
...
seleccionados para $C_{1}, C_{2}, R_{1}, R_2}$ responden solamente a ensayos
experimentales previos y tienen unicamente el objetivo de ejercitar el symulink
para corroborar su correcto funcionamiento.
