...
en este caso la determinante ser\'ia diferente a cero. Por otro lado, se observa
claramente que la matriz O es de dimensiones 2x2, por lo tanto es una matriz de
orden 2, concluyendo finalmente que el sistema de Randles de segundo \'orden es
observable, por ende, se puede implementar el Filtro de Kalman para determinar
el \acrshort{SOC} de la celda.
