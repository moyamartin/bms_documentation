...
Este dispositivo es el que centraliza toda la información, es el encargado de recibir procesar, almacenar y retransmitir todos los datos provenientes de los subsistemas del BMS por los puertos de comunicación previamente mencionados.
Debe ser capaz de interpretar y poder comunicarse con los sensores, y tener la capacidad de cómputo y frecuencia necesarias para cumplir con los tiempos de muestreo y la ejecución del Filtro de Kalman.
...
Este dispositivo es el que finalmente nos provee el valor de corriente que circula a través de las celdas hacia la carga o desde el cargador. El dato de la corriente es clave para el correcto funcionamiento del Filtro de Kalman y nos permite tomar acciones de seguridad en caso de valores de corriente elevados o variaciones bruscas de esta.
