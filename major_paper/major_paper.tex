...
\'esta no se encuentra preparada para utilización del usuario ya que no posee 
...
\ref{Section_battery_pack}, donde se utiliz\'o 6 modelos (\texttt{Cell}) y la corriente
