...
A partir de \'esta secci\'on se presenta el desarrollo matem\'atico y la
implementaci\'on f\'isica del \acrshort{BMS}, incluyendo el pack de bater\'ias,
el modelo matem\'atico de la celda de Litio-Ion junto a sus algortimos de
...
sistema f\'isico real.  Encontramos significativo dar a conocer nuestro interés en
el desarrollo de este proyecto en particular.
...
laboratorio de la misma. El proceso de selección de la celda, de la optención de
los datos experimentales, su procesamiento y de la selección y desarrollo de un
modelo de la celda de Litio-Ion son tambien presentados a continuación. 
...
investigar el modelo de la celda, correr simulaciones de la misma y pantear
...
a partir del cual calculamos los parámetros internos del modelo de la celda de
Litio-Ion que se presentará en la sección \ref{dev_batt_model}.
...
recursivo de optimización para ajustar los parámertros y con ellos el
