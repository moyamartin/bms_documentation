...
De los protocolos mencionados el más utilizado por su superadora relación costo-confiabilidad es el protocolo \acrshort{CAN}, sin mencionar que desde sus orígenes fue desarollado especificamente para el rubro automotríz.

\subsubsection{Protocolo CAN}
Este es un protocolo serie que trabaja en según el modelo \acrshort{OSI} (\acrfull{OSI}) en la primera y la segunda capa, también conocidas como la capa física y la capa de enlace de datos respectivamente.
