...
\newacronym{BLDC}{BLDC}{Brushless DC electric motor}
...
\newacronym{CSMA/CD+CR}{CSMA/CD+CR}{Carrier Sense, Multiple Access/Colission Detection + Colission Resolution}
...
\newacronym{UART}{UART}{Universal Asynchronous Receiver Transmiter}
